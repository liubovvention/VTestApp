...
export {default as DetailsScreen} from 'src/screens/DetailsScreen/DetailsScreen';
export {default as SettingsScreen} from 'src/screens/SettingsScreen/SettingsScreen';
